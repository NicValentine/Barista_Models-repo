...
# Assignment 4 - Simple Declarative Memory

# We have taken the former barsita model and added the declarative memory module to it. 
# The barista makes a random DM request for a garnish for the latte of either i) cinnamon or ii) pumpkin spice
