...
# ASSIGNMENT 12 - Spreading activation added to model
...
class Barista(ACTR):
    ...
    # Add spreading activation to model
    ...
    # spencer is recalled in the production at the end of the sequence,
    # with the focus buffer spreading activation to the his side order, a biscotti. 
