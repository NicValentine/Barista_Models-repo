...
class MyAgent(ACTR):
    ...
    DM.add('customer:mary condiment:siracha')
    DM.add('customer:jerry condiment:mayonnaise')   
    DM.add('customer:sue condiment:siracha') 
...
##        DM.add('customer:mary condiment:ketchup')
    ...
    def ham(focus='task:sandwich object:ham', something='state:done'):
        ...
        focus.set('customer:mary object:condiment') ###

    def condiment_DM_request(focus='customer:?customer object:condiment'):
