...
# they should be different as they are the actions of different agents, but I ran into some 
# issues when I tried to do this such as how a production from one action module fires a production from another action module
# this can be fixed
...
class ActionModule(Model):     
    ...
    # 5) 
    # 'espresso_machine', 'grinder_button', 'on'.........this should trigger the java jolt espresso machine
    ...
    # 7ii) 'espresso_machine','grinder_button','off' # grinding ends once portafilter is full
