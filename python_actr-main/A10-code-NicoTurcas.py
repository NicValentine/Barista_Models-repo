...
# Assignment 10 - rehearsal ability

# We have taken the former barsita model and have it rehearse and order to forget it less.
# in this case the agent rehearses 'pumpkin_spice' and is biased towards recalling this garnish over others. 
...
class MyAgent(ACTR):
    ...
    def production_make_latte_mix_steamed_milk_and_espresso(focus='task:latte operation:make_latte'):
        ...
        focus.set('task:latte operation:rehearse_garnish')
    
    # rehearsal....this will cause the agent to be biased towards recalling the pumpking spice garnish over the others
    def production_rehearsal(focus='task:latte operation:rehearse_garnish'):
        DM.add('garnish:pumpkin_spice')
