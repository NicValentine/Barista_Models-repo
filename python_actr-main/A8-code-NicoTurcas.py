...
# ASSIGNMENT 8 - Embody the agent

# This is a GOMS model of a barista training a new hire how to make an espresso shot.
# We took the former barista model and embodied it in a cafe environment
# with an espresso machine that can grind beans and pull shots. 
...
class Barista(ACTR):
    ...
    def production_lift_portafilter(focus='task:espresso operation:lift_portafilter'):
        print('Barista: Hey there newbie, welcome to the team, lemme teach you how to make an espresso.')
        print('Barista: So first, grab the portafilter off the counter.')
    ...
    def production_grind_beans(focus='task:espresso operation:grind_beans'):
        print('Barista: Alright, turn on the grinder and grrrinnndd dem beans!')
    ...
    def production_grab_cup(focus='task:espresso operation:grab_cup'):
        print('Barista: Alright, lets just pick up the cup on the counter.')
    ...
    def production_serve_drink(focus='task:espresso operation:serve_drink'):
        print('Barista: Okay, that is it, just bring the espresso to the pick area to serve to the guest. PICK UP!')
